...
account_sid = "AC77b29b718d9050f212abb9d6d825b6a6"
auth_token = "fe704bb46f746069f76c5320cb625bc3"  
fromnumber = "+17739040325"
tonumber = "+17738379443"
body_text = "Hola yo me llamo Twilio!"
######################################################
...
while user != "q":
	response, flag = response_handler(user)
	if flag == "0":
		send (fromnumber, tonumber, response)
	elif flag == "1":
		send_media (fromnumber, tonumber, response)
	user = raw_input("Enter a text to send your TWILIO number.  Or enter q to quit: \n> ")
